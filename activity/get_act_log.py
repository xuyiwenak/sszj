            ...
            if "logdb_" in dbname:
                ...
                try:
                    ...
                    for table_row in cur_logdb.fetchall():
                        ...
                        bool_in_range=compare_time(date,'2017-04-13 00:00:00','2017-06-12 23:59:59')
                        ...
                        log_cur.execute("select map_id, char_id, char_level, total_damager, totoal_injured, type, creature_killed, money_gained,death_times, exp_gained, op_type ,log_time,%s\
                                    from %s where log_time between unix_timestamp('2017-04-13 00:00:00') and unix_timestamp('2017-06-12 23:59:59')" % ( gateway_id, table_name))
