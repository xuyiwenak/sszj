...
def online_data2db(DB_HOST, DB_USER, DB_PWD, db_name, server_list,insert_dbname,time_start,time_end):
            ...
            if "logdb_" in dbname:
                ...
                try:
                    ...
                    for table_row in cur_logdb.fetchall():
                        ...
                        log_cur.execute("select char_id, %s, char_level, metier_id, map_id, value, delta,op_type, var, log_time\
                        ...
                        #print log_data
                        dest_sql = "insert into log_jifen values(%s, %s, %s, %s, %s, %s ,%s, %s, %s ,%s)"
    ...
    dest_cur.close()
    dest_conn.close()
create_log_jifen_table.create_table('103.244.235.249', 'sszj', 'DR9m_wqsgF8a', 'data_stat_ss', 'log_jifen')
online_data2db("103.244.235.249", 'sszj', 'DR9m_wqsgF8a', 'data_stat_ss','conf_server_list_2','log_jifen','2017-08-09 00:00:00','2017-08-09 23:59:59')