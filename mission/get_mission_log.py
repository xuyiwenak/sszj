            ...
            if "logdb_" in dbname:
                ...
                try:
                    ...
                    for table_row in cur_logdb.fetchall():
                        ...
                        log_cur.execute("select char_id ,char_level ,metier_id , instance_id , task_id ,op_type ,repetition ,log_time,%s\
                        ...
                        #print log_data
                        dest_sql = "insert into mission_log values(%s, %s, %s, %s, %s, %s ,%s, %s, %s)"
