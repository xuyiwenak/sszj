...
import MySQLdb
import time
import create_active_player_table
...
def query_role(db_host, db_user, db_passwd, db_name, db_port, gateway_id):
    ...
    try:
      ...
      for row in cur.fetchall():
         ...
         if char_id == 0:
            print "roleid %d ,charid == 0" %role_id
            continue
...
create_active_player_table.create_table('103.244.235.249', 'sszj', 'DR9m_wqsgF8a', 'data_stat_ss', 'char_property')
